...
feature 'user views books' do
  ...
  # context "still fuck capybara" do
  #   let!(:book2) {
  #     create(:book,
  #     title: "The Wise Man's Fear",
  #     cover: "http://covers.openlibrary.org/b/id/8155423-L.jpg")
  ...
  #   let!(:book_genre2) { create(:book_genre, book: book2, genre: genre2) }
    scenario "filter books by genre" do
      # binding.pry
      visit books_path
      find("option[value='#{book_genre1.genre.id}']").click
      # page.find("#genre_id").click
      # page.find("option", text: "Fantasy").click
      # within "#genre_id" do
      #   find("option", text: "Fantasy").click
      # end
      click_button("Filter")
      save_and_open_page
